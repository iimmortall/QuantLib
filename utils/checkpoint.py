...
def load_checkpoint_no(model, optimizer, scheduler, q_optimizer=None, q_scheduler=None, t_optimizer=None,
                       t_scheduler=None, gpu_n=None, checkpoint=None, model_type=None, alpha=None,
                       optimizer_alpha=None, beta=None, optimizer_beta=None):
    print('load checkpoint from', checkpoint)
    checkpoint = torch.load(checkpoint)
    checkpoint_dict = checkpoint['state_dict']
...
def load_checkpoint(model, optimizer, scheduler, q_optimizer=None, q_scheduler=None, t_optimizer=None,
                    t_scheduler=None, gpu_n=None, checkpoint=None, model_type=None, alpha=None,
                    optimizer_alpha=None, beta=None, optimizer_beta=None):
    print('load checkpoint from', checkpoint)
...
def save_checkpoint(config, model, optimizer, scheduler, q_optimizer, q_scheduler, t_optimizer=None,
                    t_scheduler=None, epoch=0, step=0, model_type=None, alpha=None, optimizer_alpha=None,
